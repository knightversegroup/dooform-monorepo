...
import { LogoLoader, Button } from '@dooform/shared';
    ...
    <>
      ...
      <div className="w-full">
        ...
        <Button
          ...
          className="w-full gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {googleLoading ? (
          ...
          <span>{googleLoading ? 'กำลังสมัคร...' : 'สมัครด้วย Google'}</span>
        </Button>
