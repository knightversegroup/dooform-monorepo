...
export class GetPlaceholdersUseCase implements UseCase<GetTemplateByIdDto, { placeholders: string[] }> {
  constructor(
  ...
  async execute(dto: GetTemplateByIdDto): Promise<Result<{ placeholders: string[] }>> {
    ...
    return { placeholders: template.placeholders ?? [] } as any
  }
}
